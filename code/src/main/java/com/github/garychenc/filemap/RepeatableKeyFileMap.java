...
import com.github.garychenc.filemap.store.StoreIsFullException;
...
/**
 * RepeatableKeyFileMap 类为 FileMap 的一个实现，该类的 add 方法允许添加新 Key - Value 的时候，新的 Key 可与原来 Map 中已经存在的 Key 重复。假如需要 Key 的唯一性，由客户端自己保证。
 *
 * @author Gary CHEN
 *
 */
public class RepeatableKeyFileMap extends AbstractFileMap {

    /**
     * 创建一个 RepeatableKeyFileMap 对象。创建 RepeatableKeyFileMap 对象失败时抛出运行时异常。
     *
     ...
     */
    public RepeatableKeyFileMap(String storeDirPath, String storeName) {
     ...
     */
    public RepeatableKeyFileMap(String storeDirPath, String storeName, boolean isFlushFileCacheEveryOperation) {
     ...
     */
    public RepeatableKeyFileMap(String storeDirPath, String storeName, boolean isFlushFileCacheEveryOperation, boolean isStrictStorage) {
     ...
     */
    public RepeatableKeyFileMap(String storeDirPath, String storeName, boolean isFlushFileCacheEveryOperation, boolean isStrictStorage, int aFileMapStoreMaxSize) {
